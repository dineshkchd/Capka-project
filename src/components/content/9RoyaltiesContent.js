...
(b) the amalgamated company shall furnish to the Assessing Officer a certificate in Form No. 62, duly verified by an accountant, with reference to the books of account and other documents showing particulars of production, along with the return of income for the assessment year relevant to the previous year during which the prescribed level of production is achieved and for subsequent assessment years relevant to the previous years falling within five years from the date of amalga-mation.
...
export default NineRoyaltiesContent;