...
1[8AD Computation of capital gains for the purposes of sub-section (1B) of section 45-(1) Where any person receives at any time during any previous year any amount under a specified unit linked insurance policy, including the amount allocated by way of bonus on such policy, then, —

where the amount is received for the first time under the specified unit linked insurance policy during the previous year, the capital gains arising from receipt of such amount by such person during the previous year in which such amount is received shall be calculated in accordance with the formula:− A-B
where, -
...
1. Inserted by the Income tax (2nd Amendment) Rules, 2022 Notification No. 8/2022 dated 18.01.2022
