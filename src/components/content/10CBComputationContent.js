const TenCBComputationContent = `



1[Computation of interest income pursuant to secondary adjustments.
...
NOTE-
1. Rule 10CB inserted by the Income-tax (Fifteenth Amendment) Rules, 2017, w.e.f. 15-6-2017.
...
export default TenCBComputationContent;