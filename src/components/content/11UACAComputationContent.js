const UACAComputationContent = `


1[11UACA Computation of income chargeable to tax under clause (xiii) of sub-section (2) of section 56. -  
...
(i) where the sum is received for the first time under the life insurance policy during the previous year (hereinafter referred to as first previous year), the income chargeable to tax in the first previous year shall be computed in accordance with the formula,— A-B
...
1. Inserted by the Income tax Amendment (Sixteenth Amendment), Rules, 2023 Notification No. 61/2023 dated 16.08.2023

 
`;

export default UACAComputationContent;