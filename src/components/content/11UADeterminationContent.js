const UAADeterminationMarketContent = `
...
3[(2) Notwithstanding anything contained in sub-clause (b) or sub-clause (c), as the    case may be, of clause (c) of sub-rule (1):–  
...
(a) fair market value of unquoted equity shares =(A–L)× [PV/PE],  where,  
...
Provided that the consideration has been received by the undertaking from a venture capital fund or a venture capital company or a specified fund, within a period of ninety days before or after the date of issue of shares which are the subject matter of valuation. Explanation.– For the purposes of this clause,–
...
(ii) lause (a) or sub-clause (b) or sub-clause (d) of clause (A), for  consideration received from a  non- resident, by an amount not exceeding ten per cent. of the valuation price, the issue price shall be deemed to be the fair market value of such shares.
...
1. Sub-clause (b) substituted by the Income-tax (Twentieth Amendment) Rules, 2017, w.e.f. 1-4-2018. Prior to its substitution, said clause, as amended by the Income-tax (Fifteenth Amendment) Rules, 2012, w.e.f. 29-11-2012, read as under :
...
2. Words "or an accountant" omitted by the Income-tax (Sixth Amendment) Rules, 2018, w.e.f. 24-5-2018

3. Substituted by the Income-tax (Twenty first Amendment),  Rules, 2023. Notification No. 81 /2023 dated 25.09.2023

for sub-rule (2) the word
...
export default UAADeterminationMarketContent;