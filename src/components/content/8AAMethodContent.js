...
1(5). In case of the amount which is chargeable to income-tax as income of specified entity under subsection (4) of section 45 under the head ?Capital gains?,-
...
export default EightAAMethodContent;