const TwoDDComputationContent = `


1[2DD. Computation of exempt income of specified fund for the purposes of clause (23FF) of section 10.-(1) For the purpose of clause (23FF) of section 10, income of the nature of capital gains, arising or received by a specified fund, which is attributable to units held by non-resident (not being a permanent establishment of a non-resident in India) in such specified fund shall be computed as under:-  
...
(4) The Principal Director General of Income-tax (Systems) or the Director General of Income tax (Systems), as the case may be, shall specify the procedure for filing of the Form Nos. 10-II and 10-IJ and shall also be responsible for evolving and implementing appropriate security, archival and retrieval policies in relation to the statements so furnished under this rule. Explanation:- For the purposes of this rule, the expressions,-
...
1. Inserted by The Income-tax (34th Amendment) Rules, 2021 Notification No. 138/2021 dated 27.12.2021



`;

export default TwoDDComputationContent;