const TwoDCGuidelinesContent = `

12DC. Guidelines for notification under clause (23FE) of section 10.- (1) For the purposes of notification under sub-clause (iv) of clause (c) of Explanation to the clause (23FE) of section 10, the pension fund shall make an application in Form No. 10BBA enclosing therewith relevant documents and evidence, to the,-
...
export default TwoDCGuidelinesContent;