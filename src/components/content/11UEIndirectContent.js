...
(c) the declarant and all the interested parties shall irrevocably withdraw, terminate or discontinue all the proceedings to enforce or pursue attachments in respect of any award, order or judgement or any other relief against the Republic of India or Indian affiliates with respect to the relevant order or orders and furnish evidence thereof and a declaration in the undertaking in Form No. 1 to the effect that it shall not, under any circumstances, reopen or file any such proceeding in future against the Republic of India or Indian affiliates with respect to the relevant order or orders;
...
(e) the declarant and all the interested parties shall irrevocably waive any right to seek or pursue any claim for costs in respect of any proceeding referred to in clauses (a), (b), (c) or (d), including but not limited to any proceeding initiated by the Republic of India to set aside the award, order or judgement, or any other relief, referred to in clauses(a), (b), (c) or (d), issued in favour of the declarant or any of the interested parties;
...
export default UEIndirectContent;