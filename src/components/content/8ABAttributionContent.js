const EightABAttributionContent = `


18AB. Attribution of income taxable under sub-section (4) of section 45 to the capital assets remaining with the specified entity, under section 48 
...
(7) Form No. 5C shall be furnished on or before the due date referred to in the Explanation 2 below subsection (1) of section 139 for the assessment year in which the amount is chargeable to tax under subsection (4) of section 45.
...
1. Inserted by Income tax Amendment (18th Amendment), Rules, 2021 Notification dated 2nd July, 2021



`;

export default EightABAttributionContent;