const UDeterminationFairContent = `

1[8AC. Computation of short term capital gains and written down value under section 50 where depreciation on goodwill has been obtained.

For the purposes of proviso to section 50, the written down value of the block of the asset and short term capital gains, if any, for the previous year relevant to the assessment year commencing on the 1st day of April, 2021 shall be determined in accordance with this rule.
...
the actual cost of any asset falling within the block of assets “intangible”, other than goodwill, acquired during the previous year relevant to the assessment year commencing on the 1st day of April, 2021, such excess shall be deemed to be the capital gains arising from the transfer of short-term capital assets.
...
1. Inserted by The Income tax Amendment (19th Amendment), Rules, 2021 Notification No. 77/2021 dated 07.07.2021

`;

export default UDeterminationFairContent;