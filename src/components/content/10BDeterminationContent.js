const TenBDeterminationContent = `
...
(ii) the data relating to the financial year immediately preceding the current, if the data relating to the current year is not available at the time of furnishing the return of income by the assessee, for the assessment year relevant to the current year:
...
export default TenBDeterminationContent;