const TenVGuidelinesContent = `


[Guidelines for application of section 9A.

10V. (1) Where the investment in the fund has been made directly by an institutional entity, the number of members and the participation interest in the fund shall be determined by looking through the said entity, if it,—
...
(ii) does not exceed a period of eighteen months beginning from the date on which the fund is setup or is not beyond the final closing of the fund, whichever is earlier, and bona fideefforts are made to satisfy the conditions specified in the clauses (c), (d) and (e) of sub-section (3) of section 9A;
...
1(11) The provisions of sub-rule (5) to sub-rule (10) shall not apply on or after the 1st day of April, 2019.
...
(i) In case where the fund is Category-I foreign portfolio investor referred to in item (i), item (ii) or item (iii), and subitem III of item (iv) of clause (a) of regulation 5 of the Securities and Exchange Board of India (Foreign Portfolio Investors) Regulations, 2019, made under the Securities and Exchange Board of India Act, 1992 (15 of 1992), the amount of remuneration shall be 0.10 per cent of the asset under management.
...
3[Provided also that the provisions of sub-rules (3) to (12) of rule 10VA shall, mutatis mutandis, apply to the application made under the second proviso as they apply to application made under subrule (2) of the said rule:
...
a) asset under management means annual average of themonthly averageof the opening and closing balances of the value of such part of the fund which is managed by the fund manager;

(b) “managemen fee” means the amount as mentioned in the certificate obtained from an accountant, a defined in clause (i) of Explanation to rule 11UB, for this purpose;

(c) “ Specified hurdle rate means pre-defined threshold beyond which the fund agrees to pay a share of the profits earned by the fund from the fund management activity undertaken by the fund manager.
...
[2(14) For the purposes of clause (a) of sub-section (4) of 

section 9A, a fund manager shall not be considered to be a connected person of the fund merely for the reason that the fund manager is undertaking fund management activity of the said fund.

2(15) For the purposes of clause (d) of sub-section (4) of section 9A, any remuneration paid to the fund manager, by the fund, which is in the nature of fixed charge and not dependent on the income or profits derived by the fund from the fund management activity undertaken by the fund manager shall not be included in the profits referred to in the said clause, if the conditions specified in clause (m) of sub-section (3) of 

section 9A are satisfied and such fixed charge has been agreed by the fund manager in writing at the beginning of the relevant fund management activity.]


Note-

1. Inserted by the Income-tax (10th Amendment) Rules, 2020  Notification dated 27.05.2020

2. Substitution by the Income-tax (10th Amendment) Rules, 2020 Notification dated 27.05.2020

3. Inserted by the Income-tax (2nd Amendment) Rules, 2021  Notification dated 09.03.2021



`;

export default TenVGuidelinesContent;