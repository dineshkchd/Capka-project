const TenRBReliefContent = `


110RB. Relief in tax payable under sub-section (1) of section 115JB due to operation of subsection (2D) of section 115JB.-

- (1) For the purposes of sub-section (2D) of section 115JB, the tax payable by the assessee company under sub-section (1) of section 115JB, for the previous year referred to in that section, shall be reduced by the following amount, namely:-
...
1. Inserted by Income tax (23rd Amendment), Rules, 2021.Notification dated 10.08.2021
...
export default TenRBReliefContent;