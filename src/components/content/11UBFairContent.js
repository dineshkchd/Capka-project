...
the value on the specified date of such firm or association of persons, shall be determined by a merchant banker or an accountant in accordance with any internationally accepted valuation methodology as increased by the liability, if any, considered in such determination;

(ii)

 

the portion of the value computed in clause (i) as is equal to the amount of its capital shall be allocated among its partners or members in the proportion in which capital has been contributed by them and the residue of the value shall be allocated among the partners or members in accordance with the agreement of partnership firm or association of persons for distribution of assets in the event of dissolution of the firm or association, or, in the absence of any such agreement, in the proportion in which the partners or members are entitled to share profits and the sum total of the amount so allocated to a partner or member shall be treated as the fair market value of the interest of that partner or member in the firm or the association of persons, as the case may be.
...
the share of the foreign company or entity is listed on a stock exchange on the specified date, the fair market value of all the assets owned by the foreign company or the entity shall be determined in accordance with the following formula, namely:—
...
the share in the foreign company or entity is not listed on a stock exchange on the specified date, the value of all the assets owned by the foreign company or the entity shall be determined in accordance with the following formula, namely:—
...
if he is a member or partner in any entity engaged in rendering accountancy or valuation services then,—
...
the entity or its affiliates has presence in more than two countries; and

(ii)

 

the annual receipt of the entity in the year preceding the year in which valuation is undertaken exceeds ten crore rupees;
...
if he is pursuing the profession of accountancy individually or is a valuer then,—
...
his annual receipt in the year preceding the year in which valuation is undertaken, from the exercise of profession, exceeds one crore rupees; and
...
"connected person" shall have the meaning as assigned to it in clause (4) of section 102;
...
"telegraphic transfer buying rate" shall have the meaning as assigned to it in the Explanation to rule 26;

(v)

 

"observable price" in respect of a share quoted on a stock exchange shall be the higher of the following:—
...
the average of the weekly high and low of the closing prices of the shares quoted on the said stock exchange during the six months period preceding the specified date; or

(b)

 

the average of the weekly high and low of the closing price of the shares quoted on the said stock exchange during the two weeks preceding the specified date;
...
"specified date" shall have the meaning as assigned to it in clause (d) of Explanation 6 to clause (i) of sub-section (1) of section 9;

(viii)

 

the terms "merchant banker" and "recognised stock exchange" shall have the meaning as assigned to them in rule 11U;
...
in relation to an Indian company, means the balance-sheet of such company (including the notes annexed thereto and forming part of the accounts) as drawn up on the specified date which has been audited by the auditor of the company appointed under the laws relating to companies in force; and

(b)

 

in any other case, means the balance-sheet of the company or the entity (including the notes annexed thereto and forming part of the accounts) as drawn up on the specified date and submitted to the relevant authority outside India under the laws in force of the country in which the foreign company or the entity is registered or incorporated:
