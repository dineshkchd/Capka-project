const SixDDBNotificationContent = `
...
1. Substituted for "Member (L)" by the Income-tax (Third Amendment) Rules, 2017, w.e.f. 23-3-2017.

`;

export default SixDDBNotificationContent;