const FiveGOptionFormContent = `



1[5G. Option form for taxation of income from patent under section 115BBF.
...
1. Rule 5G inserted by the Income-tax (Fifth Amendment) Rules, 2017, w.e.f. 1-4-2017.

 
 
`;

export default FiveGOptionFormContent;