const UABDeterminationContent = `

1[Determination of fair market value for inventory.
...
1. Rule 11UAB inserted by the Income-tax (Ninth Amendment) Rules, 2018, with prospective effect from 1-4-2019 and shall apply in relation to assessment year 2019-20 and subsequent years.


`;

export default UABDeterminationContent;